...
c      parameter (nlte_file=248533) !updated by the user. is the length of the number in lines in the auxiliary nlte data file (which is the number of models)
      parameter (icomp=1) !updated by user. 8 is Intel Fortran, 1 or 4 is GNU
