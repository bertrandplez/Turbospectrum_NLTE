...
C***********************************************************************
      REAL*8 FUNCTION HLINOP(WAVE,NBLO,NBUP,WAVEH,T,XNE,H1FRC,HE1FRC,
     *                     DOPPLE)
C
...
C
      ...
      integer  :: i, ifvac, nblo, nbup
      real(dp) :: h1frc, he1frc, xne, t, dopple, hprofl
      REAL(dp) :: WAVEH,WAVE,WCON,WREFLECT
      REAL(dp) :: REDCUT,BLUECUT
      REAL(dp) :: EHYD(100),CONTH(100),WCUT(100)
      REAL(dp) :: VACAIR
...
C  Dappen et al 1987, ApJ 319, 195). The shape of the far wings should 
